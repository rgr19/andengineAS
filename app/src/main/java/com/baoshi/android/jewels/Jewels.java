...
import com.baoshi.android.jewels.constants.IConstants;
import com.baoshi.android.jewels.entity.BackgroundCell;
import com.baoshi.android.jewels.entity.BorderSprite;
import com.baoshi.android.jewels.entity.JewelSprite;

import com.baoshi.android.jewels.R;
...
public class Jewels extends BaseGameActivity implements IOnSceneTouchListener, IConstants {
	...
	private void initLongestChain(){
		//Longest Chain
		final Text longestChain = new Text(146, 422, this.mLongestChainFont, "最大连续消除数:", HorizontalAlign.LEFT);
