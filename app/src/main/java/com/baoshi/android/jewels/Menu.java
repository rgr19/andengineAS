package com.baoshi.android.jewels;
...
import com.baoshi.android.jewels.constants.ManagerAD;
...
//				this.mModelScene.back();
	...
	private void initMenu(){
		...
		ManagerAD.openPush(this);
		ManagerAD.openKZ(this);
		ManagerAD.openMedia(this);
		ManagerAD.openLJKPush(this);
		...
		this.mNewGameText = new Text(centerX +47, 136, this.mFont, "开始游戏");//文字
		...
		this.mRankingText = new Text(centerX +70, 206, this.mFont, "排行榜");//文字
		...
		this.mQuitText = new Text(centerX +82, 276, this.mFont, "退出");//文字
	...
	private void initModel(){
		...
		this.mNormalModeText = new Text(centerX +27, 137, this.mFont, "普通模式");//文字
		...
		this.mTimedModeText = new Text(centerX +40, 207, this.mFont, "计时模式");//文字
		...
		this.mInfiniteModeText = new Text(centerX +28, 277, this.mFont, "无尽模式");//文字
		...
		final Text backText = new Text(centerX +110, 345, this.mFont, "返回");//文字
	...
	private void initNormalRank(){		
		...
		final Text selectModelText = new Text(centerX-7, 25, this.mFont, "计时模式排行榜");//文字
		...
		final Text backText = new Text(centerX +110, 76, this.mFont, "返回");//文字
		backText.setScale(0.8f, 0.9f);
	...
	private void initTimedRank(){
		...
		final Text selectModelText = new Text(centerX-18, 25, this.mFont, "普通模式排行榜");//文字
		selectModelText.setScale(0.7f, 0.8f);
